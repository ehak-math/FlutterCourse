...
main() {
  ...
  Address address1 = Address('KompongChnang', '7F', '19875E');
  Employee employeeWorkDart =
      Employee.MobileDeveloperWithDART('Pich Rong', 9000, 7, address1);
  employeeWorkDart.displayResult();

  // object for Employee skill Mobile Developer work with FLUTTER
  Address address2 = Address('Phnom Penh', '9A', '65452ED');
  Employee employeeWorkFlutter =
      Employee.MobileDeveloperWithFlutter('Math Ehak', 5000, 4, address2);
